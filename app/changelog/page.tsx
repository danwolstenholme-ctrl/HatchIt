      ...
      <main className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 relative">
            ...
            >
              <div className="w-12 h-12 rounded-sm bg-zinc-900/70 backdrop-blur-xl border border-zinc-800/50 flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.1)]">
                <GitCommit className="w-6 h-6 text-emerald-500" />
              </div>
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
                System <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-400">Changelog</span>
              </h1>
            </motion.div>
          ...
          <div className="space-y-12 relative">
            ...
            {changes.map((change, index) => (
              ...
              >
                ...
                <div className="bg-zinc-900/70 backdrop-blur-xl border border-zinc-800/50 rounded-sm p-6 md:p-8 hover:border-emerald-500/20 transition-colors group shadow-2xl shadow-black/50">
