  ...
  const coreFeatures = [
    {
      ...
      description: 'A distributed intelligence system. Sonnet constructs the logic. Opus refines the accessibility. Gemini audits the security. Three minds, one output.',
      details: [
        'Sonnet 4: High-velocity logic generation',
        'Opus 4: Semantic & accessibility refinement',
        'Gemini 2.5: Security & best-practice audit',
